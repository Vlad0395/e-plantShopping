    ...
    <div>
      ...
      {!showCart ? (
        <div className="product-grid">
          {plantsArray.map((el, index) => (
            <div key={index}>
              <h1>{el.category}</h1>
              <div className="product-list">
                {el.plants.map((el, idx) => (
                  <div key={`item-${idx}`} className='product-card'>
                    <div className='product-title'>{el.name}</div>
                    <img src={el.image} alt={el.name} className='product-image' />
                    <div className='product-title'>{el.description}</div>
                    <div className='product-price'> {el.cost}</div>
